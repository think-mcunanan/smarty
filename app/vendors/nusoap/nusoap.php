	...
	*/
	function nusoap_base() {
		//$this->debugLevel = $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel;
            $this->debugLevel = $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel =0;
	}
	...
	*/
	function getGlobalDebugLevel() {
		//return $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel;
                return $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel=0;
	}
	...
	*/
	function invoke_method() {
		...
		if ($this->operations[$this->methodname]['function'])
		{
			...
			{
				$this->methodreturn = call_user_func_array($method, array_values($this->methodparams));												
			}
		}
		else
		{
