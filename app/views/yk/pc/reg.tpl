...
<table border='0' cellpadding='6'>
    <tr>
        ...
        <td align='left'><input type='text' name='r_name' value='{$name}' size='16' maxlength='50' /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align='left'><input type='text' name='r_year' value='{$year}' size='5' maxlength='4' />年 <input type='text' name='r_month' value='{$month}' size='3' maxlength='2' />月 <input type='text' name='r_day' value='{$day}' size='3' maxlength='2' />日</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align='left'><input type='checkbox' name='r_mailkubun' value='1' {if $mailkubun== 1}checked='checked' {/if} />
