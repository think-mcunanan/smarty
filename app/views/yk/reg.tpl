<table width='90%' border='0'>
    <tr>
        ...
        <input type='text' name='r_phone' value='{$phone}' size='16' maxlength='20' /><br />
        <br />
        ...
        <br />
        ・誕生日<br />
        <input type='text' name='r_year' value='{$year}' size='5' maxlength='4' />年 <input type='text' name='r_month' value='{$month}' size='3' maxlength='2' />月 <input type='text' name='r_day' value='{$day}' size='3' maxlength='2' />日<br />
        <br />
        ・パスワード更新：<br />
        　(半角英数字のみ)<br />
