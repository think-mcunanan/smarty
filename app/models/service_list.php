...
class ServiceList extends AppModel
{
	var $name       = 'ServiceList';
    var $useTable   = 'services';
    var $primaryKey	= 'GDCODE';

    var $database_set = false;
    var $useDbConfig = 'database_schema';

    var $hasOne     = array('StoreService' => array(
                                    'foreignKey' => false,
                                    'conditions' => array('ServiceList.GDCODE = StoreService.GDCODE'))   );
