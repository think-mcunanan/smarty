...
class ServersController extends WebServicesController
{
    ...
    function wsCustomerMergeSave($sessionid, $strcode, $fromccode, $toccode, $transcode, $keyno, $companyid, $params){
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------
        // SQL Update Third Party Customer Code
        //--------------------------------------------------------------------------------------------------------------------------------------------------

        // BEAUTY MERIT CUSTOMER
        $sqlstatements[] = "UPDATE bm_reservation
                                SET ccode = '{$toccode}'
                            WHERE ccode = '{$fromccode}'";

        // RESERVIA CUSTOMER
        $sqlstatements[] = "UPDATE rv_customer
                                SET ccode = '{$toccode}'
                            WHERE ccode = '{$fromccode}'";
        //HPB CUSTOMER
        // No need to update because HPB customer don't have it's own user id
