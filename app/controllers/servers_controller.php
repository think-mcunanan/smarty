...
// print($param['date']); die();
        ...
        $sql = "/*wsSearchAvailableStaff*/
                SELECT DISTINCT
                    ...
                    Staff.STORECODE,
                    Staff.STAFFNAME,
                    ifnull((select rows from staffrowshistory where storecode = StaffAssignToStore.storecode and staffcode = StaffAssignToStore.STAFFCODE and datechange <= '". $param['date'] ."'  order by datechange desc limit 1),".DEFAULT_ROWS.") as origrows,
                    ifnull((select phonerows from staffrowshistory where storecode = StaffAssignToStore.storecode and staffcode = StaffAssignToStore.STAFFCODE and datechange <= '". $param['date'] ."' order by datechange desc limit 1), ".DEFAULT_PHONEROWS.") as origphonerows,
                    Store.STORENAME,
