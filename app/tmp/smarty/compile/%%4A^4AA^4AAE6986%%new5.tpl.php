<?php /* Smarty version 2.6.26, created on 2012-12-26 16:32:12
         compiled from /var/www2/sipssbeauty/mobile_station_beauty/serverside/app/views/yk/pc/new5.tpl */ ?>
<center>
<form name='YkNew4Form' action="<?php echo $this->_tpl_vars['form_action']; ?>
" method="post">
...
" width="120" height="25"></td>
		<td><img src="<?php echo $this->_tpl_vars['html']->url('/img/new/touroku.gif'); ?>
	...
	<tr>
		...
		<table border='0' cellpadding='6'>
			<tr>
				...
				<td align='left'><?php echo $this->_tpl_vars['trans_staff']; ?>
</td>
			</tr>
			<tr>
				<td align='right'><b>日付:</b></td>
				<td align='left'><?php echo $this->_tpl_vars['trans_date']; ?>
</td>
			</tr>
			<tr>
				<td align='right'><b>時間:</b></td>
				<td align='left'><?php echo $this->_tpl_vars['trans_time']; ?>
</td>
			</tr>
			<tr>
				<td align='right' valign='top'><b>メニュー選択:</b></td>
				<td align='left'><?php echo $this->_tpl_vars['trans_services']; ?>
</td>
			</tr>
		</table>
		</div>
